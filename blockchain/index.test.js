...
describe('Blockchain', () => {
	...
	it('adds a new block to chain', () => {
		...
		const addedBlock = blockchain.addBlock({data: newData});

		expect(blockchain.chain[blockchain.chain.length - 1].hash).toEqual(addedBlock.hash);
	});
	...
	describe('replaceChain()', () => {
		...
		describe('and the `validateTransactions` flag is true', ()  =>{
			it('calls validTransactionData()', ()=>{
				...
				const originalValidRransactionData = blockchain.validTransactionData;
				...
				blockchain.validTransactionData = originalValidRransactionData;
			})
		});
	});
	...
	describe('validTransactionData()', () => {
		...
		describe('and a block contians multiple identical transactions', () => {
			it('returns false and logs an error', () => {
